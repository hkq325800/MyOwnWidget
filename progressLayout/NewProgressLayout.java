 ...
 */
public class NewProgressLayout extends RelativeLayout {
...
//    private static final byte statusDismiss = 3;//界面调用了dismiss
    ...
    public NewProgressLayout(Context context, AttributeSet attrs,
                       int defStyle) {
    ...
    public NewProgressLayout(Context context) {
        super(context);
        initializeView(context);
    }
